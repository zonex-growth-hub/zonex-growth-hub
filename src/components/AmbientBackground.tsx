...
export function AmbientBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-[#030305]">
      {/* Background Mesh Gradient */}
      <div className="absolute inset-0 opacity-80" />

      {/* Cursor Spotlight: Smooth Mouse following ambient glow */}
      <div
        className="pointer-events-none fixed z-0 w-[600px] h-[600px] rounded-full bg-[radial-gradient(circle,rgba(138,99,248,0.08)_0%,transparent_70%)] hidden md:block"
        style={{
          left: mousePos.x - 300,
          top: mousePos.y - 300,
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.06]" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="cyber-grid" width="80" height="80" patternUnits="userSpaceOnUse">
            <path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(138,99,248,0.3)" strokeWidth="1" />
        ...
        <line x1="0" y1="160" x2="100%" y2="160" stroke="rgba(138,99,248,0.3)" strokeWidth="1">
        ...
        <line x1="0" y1="480" x2="100%" y2="480" stroke="rgba(0,240,255,0.3)" strokeWidth="1">
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(138,99,248,0.14) 0%, transparent 70%)' }}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(92,67,250,0.12) 0%, transparent 70%)' }}
